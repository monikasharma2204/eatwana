      ...
      <div className="max-w-7xl mx-auto px-4 py-12 lg:px-20 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Delivering healthy, homely & hygienic meals to students and
          ...
          <div className="lg:col-span-1">
            <h4 className="text-lg font-semibold mb-4 text-[#f27636]">
              Quick Links
            </h4>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          ...
          >
            ...
            <span className="text-[#f27636] font-semibold hover:text-[#e7582e] transition-colors duration-300">
              Monika Sharma
            </span>
          </a>
        </div>
