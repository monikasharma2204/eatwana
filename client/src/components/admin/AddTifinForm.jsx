...
const TiffinForm = ({ onSuccess, onCancel }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setErrors({ submit: error.response?.data?.message || 'Failed to create tiffin' });
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Tiffin created successfully</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-6">
            <div className="mb-6 flex items-center justify-between">
                <h2 className="text-3xl font-bold text-gray-800">Create New Tiffin</h2>
                {onCancel && (
                    <button
                        onClick={onCancel}
